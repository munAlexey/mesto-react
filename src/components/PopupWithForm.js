...
function PopupWithForm(props) {
  ...
  return (
    <div className={`pop-up pop-up_${name} ${ isOpen ? 'action_open pop-up_opened' : 'action_close' }`}>
        <div className="pop-up__block">
          ...
          <form onSubmit={onSubmit} className={`pop-up__form pop-up__form-${name}`} name={`form-${name}`} noValidate>
            {children}
