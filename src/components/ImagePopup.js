...
function ImagePopup(props) {
  ...
  return (
    <div className={`pop-up pop-up_cards ${ props.card ? 'action_open pop-up_opened' : ''}`}>
      <div className="pop-up__full-cards">
          <button type="button" className="pop-up__close-btn" onClick={props.onClose}>
          <picture>
            <source 
              srcSet={closeBtnFull}
          ...
          <img className="pop-up__card-full-img" src={props.cardInfo.link} alt={props.cardInfo.name} />
